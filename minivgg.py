...
Original file is located at
    https://colab.research.google.com/drive/1FSOSb-UcS4BLrYi9qFrSuApvz_R5Kfzi
...
8. Conv3 – 256
9. Maxpool – 2x2
10. fully Connected 512List item 

```
Implement a mini-vgg network and several of its variants. Train and test the models on the cifar-10
dataset. You need to have separate training, validation, and test set. Tune your parameter using validation
dataset.
"""
